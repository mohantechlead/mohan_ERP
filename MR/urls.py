...
urlpatterns = [
    ...
    path('inventory_mr_items/manage', views.manage_inventory_mr_items, name='manage_inventory_mr_items'),
    path('inventory_mr_items/manage/add', views.manage_inventory_mr_items_add, name='manage_inventory_mr_items_add'),
